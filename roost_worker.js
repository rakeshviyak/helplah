"use strict";
//var _roostSW = {version: 1, logging: true, appKey:"ztvcoga86d8kmi9jjq8vprgzxcahlk50", host: "http://localhost:8081", baseURL: "http://localhost:8081"};

var _roostSW = {
    version: 2,
    logging: true,
    appKey: "ztvcoga86d8kmi9jjq8vprgzxcahlk50",
        ...
        return fetch(_roostSW.host + "/api/browser/notifications?version=" + _roostSW.version + "&appKey=" + _roostSW.appKey + "&deviceID=" + encodeURIComponent(regID)).then(function(response) {
            return response.json().then(function(json) {
                ...
                for (var i = 0; i < json.notifications.length; i++) {
                    ...
                    var url = "/roost?noteID=" + note.roost_note_id + "&sendID=" + note.roost_send_id + "&body=" + encodeURIComponent(note.body);
